            ...
            <div className="space-y-4">
              {detail.report?.sourceMaterial ? (
                <section className="rounded-2xl border border-indigo-200 bg-indigo-50/60 p-5 dark:border-indigo-500/25 dark:bg-indigo-500/10">
                  ...
                  <MarkdownContent className="mt-3 max-h-136 overflow-y-auto pr-2 text-sm leading-7 text-slate-900 dark:text-slate-100" content={detail.report.sourceMaterial} />
                </section>
              ) : null}
