...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-canvas text-content dark:text-white">
        ...
        <div className="relative mx-auto grid w-full max-w-6xl items-center gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="max-w-2xl">
            <Link href="/" className="inline-flex items-center gap-3">
              <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-surface/15 text-white shadow-lg shadow-indigo-950/20 ring-1 ring-white/20">
          ...
          <div className="rounded-2xl border border-white/18 bg-surface/12 p-4 shadow-2xl shadow-indigo-950/25 backdrop-blur-xl">
            <div className="rounded-xl bg-surface p-4 text-content shadow-xl dark:text-white">
              <div className="flex items-center justify-between gap-4 border-b border-subtle pb-4">
                <div>
                  <p className="text-xs font-bold uppercase tracking-[0.18em] text-accent">Learning flow</p>
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {features.map((feature) => {
                  ...
                  return (
                    <div key={feature.label} className="rounded-lg border border-subtle bg-surface-sunken p-4 dark:bg-surface/5">
              ...
              <div className="mt-4 rounded-lg border border-emerald-200 bg-emerald-50 p-4 dark:border-emerald-500/20 dark:bg-emerald-500/10">
                ...
                <p className="mt-3 text-sm text-content-muted dark:text-slate-300">Practice attempts, predicted grades, and weak spots stay visible on your dashboard.</p>
              </div>
            </div>
          </div>
        </div>
